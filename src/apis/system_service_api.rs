...
pub async fn get_application(configuration: &configuration::Configuration, ) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<GetApplicationError>> {
