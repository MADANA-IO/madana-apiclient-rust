...
pub async fn cancel_subscription(configuration: &configuration::Configuration, planname: &str, username: &str) -> Result<std::path::PathBuf, Error<CancelSubscriptionError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/users/{username}/subscriptions/{planname}/cancel", configuration.base_path, planname=crate::apis::urlencode(planname), username=crate::apis::urlencode(username));
