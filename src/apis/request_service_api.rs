...
pub trait RequestServiceApi {
    fn add_data(&self, uuid: &str, authorization: Option<&str>, body: Option<crate::models::JsonSignedDataUtils>) -> Box<dyn Future<Item = std::path::PathBuf, Error = Error<serde_json::Value>>>;
    fn cancel_processing(&self, uuid: &str, authorization: Option<&str>, body: Option<crate::models::JsonSignedDataUtils>) -> Box<dyn Future<Item = std::path::PathBuf, Error = Error<serde_json::Value>>>;
    fn create_new_request(&self, authorization: Option<&str>, body: Option<crate::models::JsonSignedDataUtils>) -> Box<dyn Future<Item = String, Error = Error<serde_json::Value>>>;
    ...
    fn get_data(&self, uuid: &str, authorization: Option<&str>) -> Box<dyn Future<Item = crate::models::JsonSignedDataUtils, Error = Error<serde_json::Value>>>;
    ...
    fn set_result(&self, uuid: &str, authorization: Option<&str>, body: Option<crate::models::JsonSignedDataUtils>) -> Box<dyn Future<Item = std::path::PathBuf, Error = Error<serde_json::Value>>>;
}
