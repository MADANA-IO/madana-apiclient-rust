...
pub trait AccountServiceApi {
    ...
    fn create_password_reset(&self, body: Option<crate::models::JsonMdnMailAddress>) -> Box<dyn Future<Item = std::path::PathBuf, Error = Error<serde_json::Value>>>;
    ...
    fn update_password(&self, body: Option<crate::models::JsonMdnPasswordReset>) -> Box<dyn Future<Item = std::path::PathBuf, Error = Error<serde_json::Value>>>;
}
